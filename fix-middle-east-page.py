...
# 在第一个 oil-card 前插入金价卡片
html = html.replace(
    '<div class="market-card oil-card">',
    gold_card + '                    <div class="market-card oil-card">',
    1  # 只替换第一次出现
)
...
# 在 AI 预测区块之前插入 Polymarket
ai_section_start = html.find('<section class="section">\n            <h2 class="section-title">\n                <span class="section-title-icon">🤖</span>\n                AI 局勢預測')
if ai_section_start > 0:
    html = html[:ai_section_start] + polymarket_section + '\n        ' + html[ai_section_start:]

# ============================================
# 3. 补充 AI 预测详细分析
# ============================================
# 找到 AI 预测区块并替换
ai_predictions_enhanced = '''        <!-- AI 局勢預測 -->
        <section class="section">
            <h2 class="section-title">
                <span class="section-title-icon">🤖</span>
                AI 局勢預測
            ...
            <div class="predictions-grid">
                <div class="prediction-card">
                    ...
                    <div class="probability-bar-container">
                        <div class="probability-label">
                            <span>可能性</span>
                            <span class="probability-value">38%</span>
                        </div>
                        <div class="probability-bar">
                            <div class="probability-fill" style="width: 38%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="prediction-card">
                    ...
                    <div class="probability-bar-container">
                        <div class="probability-label">
                            <span>可能性</span>
                            <span class="probability-value">22%</span>
                        </div>
                        <div class="probability-bar">
                            <div class="probability-fill" style="width: 22%"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="prediction-card">
                    ...
                    <div class="probability-bar-container">
                        <div class="probability-label">
                            <span>可能性</span>
                            <span class="probability-value">97%</span>
                        </div>
                        <div class="probability-bar">
                            <div class="probability-fill" style="width: 97%"></div>
                        </div>
                    </div>
                </div>
...
# 替换整个 AI 预测区块
ai_section_pattern = r'<section class="section">\s*<h2 class="section-title">\s*<span class="section-title-icon">🤖</span>\s*AI 局勢預測.*?</section>'
html = re.sub(ai_section_pattern, ai_predictions_enhanced, html, flags=re.DOTALL)

# ============================================
# 4. 重组时间线 - 按焦点事件和日期分开
# ============================================
timeline_reorganized = '''        <!-- 時間線 -->
        <section class="section">
            <h2 class="section-title">
                <span class="section-title-icon">📅</span>
                完整時間線
...
# 替换整个时间线区块
timeline_pattern = r'<!-- 時間線 -->.*?</section>\s*</div>'
html = re.sub(timeline_pattern, timeline_reorganized.strip() + '\n        </div>', html, flags=re.DOTALL)
...
print("✅ 修复完成！")
print("\n修改摘要:")
print("1. ✅ 添加金价指标：$4,787/盎司 (+2.8%)")
print("2. ✅ 恢复 Polymarket 独立区块（4个预测卡片）")
print("3. ✅ 补充 AI 预测详细分析（每个预测增加200-300字说明）")
print("4. ✅ 重组时间线（按焦点事件和日期分开，共10个事件）")
